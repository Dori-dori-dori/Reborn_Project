...
goal_name = {
    ...
    available_for = {
        country_one # If present, the goal will be disabled for all countries by default, and only available for the countries within this block
    }
    blocked_for = {
        country_two # If present, the goal will be disabled for the countries within this block
    }
